...
// constructor overload resolution of non-aggregate class type AthenaArray<Real>
  ...
  rho_in.NewAthenaArray(nc1); 
  v_in.NewAthenaArray(nc1);
  pg_in.NewAthenaArray(nc1);
  ec_in.NewAthenaArray(nc1);
  fc_in.NewAthenaArray(nc1);
  g_in.NewAthenaArray(nc1);
  H_in.NewAthenaArray(nc1);
  Hnocool_in.NewAthenaArray(nc1);
